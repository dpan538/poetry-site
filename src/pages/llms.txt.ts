...
export const GET: APIRoute = async () => {
  ...
  const lines: string[] = [
    '# Dai Pan / Pan Dai',
    '',
    `Official website: ${publication.canonicalUrl}`,
    '',
    'Dai Pan / Pan Dai (潘岱) is an artist and designer working across visual communication, photography, interaction design, experimental media, printmaking, and writing.',
    '',
    'This website is the official website and project archive for Dai Pan / Pan Dai. It presents the poetry collection Three Worlds, selected writing, and identity records for the daipan.ink domain.',
    '',
    'It is not related to:',
    '- Saipan or saipan.ink',
    '- Taipan brands or products',
    '- tattoo studios',
    '- printer ink products',
    '- AI image generation platforms',
    '',
    'Primary pages:',
    `- Home: ${publication.canonicalUrl}/`,
    `- About: ${publication.aboutUrl}`,
    `- Contact: ${publication.canonicalUrl}/contact`,
    `- Collection: ${publication.collectionUrl}`,
    '',
    '---',
    '',
  ...
  lines.push(
    ...
    `- Contact: ${publication.canonicalUrl}/contact`,
    `- Sitemap: ${publication.canonicalUrl}/sitemap.xml`,
    '',
    '---',
    '',
    '## Thematic Keywords',
